function getReceipt() {
	text1 = ""; // starts the sting and gets passed on
	text2 = "";
	var runningTotal = 0;
	var sizeTotal = 0; //total will be added up then converted to runningtotal
	...
	getMeat(runningTotal,text1,text2);  // will pass the value on to the next function
};
//One free topping for each meat and veggie find running total then subtract one
